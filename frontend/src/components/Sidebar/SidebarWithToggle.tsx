      ...
      >
        ...
        <div className="p-6">
          <button
            ...
            className="flex items-center gap-4 px-4 py-3 rounded-lg text-lg font-medium text-red-500 hover:bg-red-500 hover:text-white transition-all duration-300 w-full"
          >
